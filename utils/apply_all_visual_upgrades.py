...
def upgrade_all_lessons():
    ...
    if lesson1:
        ...
        <p>У французькому алфавіті <strong>26 літер</strong>. </p>
    ...
    if lesson_be:
        ...
        <p>Бельгийский французский более логичен и дружелюбен! </p>
    ...
    if lesson2:
        ...
        <p>Первые слова, которые вы будете слышать каждый день на улице, в магазине и транспорте. </p>
